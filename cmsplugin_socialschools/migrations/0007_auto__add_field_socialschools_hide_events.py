...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialSchools.hide_events'
        db.add_column(u'cmsplugin_socialschools', 'hide_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialSchools.hide_events'
        db.delete_column(u'cmsplugin_socialschools', 'hide_events')
    ...
    models = {
        ...
        u'cmsplugin_socialschools.socialschools': {
            ...
            'hide_events': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
