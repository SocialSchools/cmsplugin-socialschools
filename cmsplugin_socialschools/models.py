...
class SocialSchools(CMSPlugin):
    ...
    community_and_descendants = models.BooleanField(help_text=_(u"This option will show public posts from Community and all it descendants."))
    #TODO: depreciate these fields
